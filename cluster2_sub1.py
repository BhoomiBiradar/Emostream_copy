...
topic = "cluster2_topic"  # The topic this cluster's subscribers will consume from
...
def start_cluster_subscriber(topic):
    ...
    consumer = KafkaConsumer(
        ...
        group_id='cluster2_subscriber_group',
        value_deserializer=lambda x: json.loads(x.decode('utf-8'))
    )

    print(f"Cluster 2 Subscriber is listening to '{topic}'...")
